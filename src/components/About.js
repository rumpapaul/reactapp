...
const[buttontext,setbtnText] = useState('enbal light mode')
const darkmode=()=>{
  ...
  setbtnText('enable dark mode')
    ...
    backgroundColor:'black'}) 
    setbtnText('enbal light mode')
  }
}

  return (
    <div className={`container navbar-${props.mode}`} style={mystyle}>
      <h2 className='mx-5'>About Us</h2>
      <div className="accordion" id="accordionPanelsStayOpenExample" >
...
{/* <button className='btn btn-primary my-3 mx-2' onClick={darkmode}>{buttontext}</button> */}
    </div>
  )
}
